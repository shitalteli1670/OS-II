...
Enter the request sequence: 80 150 60 135 40 35 170
Enter initial head position: 70 
Enter total disk size: 200
Enter the head movement direction (0 for Left, 1 for Right): 1

Order of request servicing: 80 135 150 170 199 0 35 40 60 
